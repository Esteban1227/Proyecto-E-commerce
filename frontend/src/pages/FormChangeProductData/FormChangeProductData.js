        ...
        <div class="contenedor_principal">
            <div class="contenedor_selectores">
                <div class="contenedor_crear_producto activo">
                    <span class="contendor_crear_producto_span">Editar Producto</span>
                </div>
            </div>

            <form id="form-createProduct" className="contenedor_formulario contenedor_formulario_crearProducto" encType="multipart/form-data">
